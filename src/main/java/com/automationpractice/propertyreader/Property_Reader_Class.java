...
public class Property_Reader_Class {
    ...
    */
    ...
    private static volatile Property_Reader_Class propInstance;

    //Create Private constructor Because of prevent the Instantiation of class
    private Property_Reader_Class() {
     ...
     * @return
     */
    public static synchronized Property_Reader_Class getInstance(){
        if (propInstance == null){
            propInstance = new Property_Reader_Class();
        }
        return propInstance;
    }
